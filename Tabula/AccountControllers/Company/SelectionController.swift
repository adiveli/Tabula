...
class SelectionController: UIViewController,UICollectionViewDataSource,UICollectionViewDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        dataSource.append(#imageLiteral(resourceName: "CardType1"))
        dataSource.append(#imageLiteral(resourceName: "CardType4"))
        dataSource.append(#imageLiteral(resourceName: "CardType3"))
    ...
    private func calculateSectionInset() -> CGFloat {
        ...
        let cellBodyWidth: CGFloat = 350 + (cellBodyViewIsExpended ? 174 : 0)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        var cellC = UICollectionViewCell()
        ...
        if indexPath.item == 0{
         let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "type1", for: indexPath) as! PromotionCardType1Cell
          ...
          let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "type2", for: indexPath) as! PromotionCardType2Cell
            ...
            cell.descriptionLabel.text = "Description"
            //cell.backgroundView?.transform = CGAffineTransform(scaleX: 0.5, y: 0.5)
            cellC = cell
